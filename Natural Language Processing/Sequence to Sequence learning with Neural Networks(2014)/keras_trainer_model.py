...
sc_embed = Embedding(S_VOCAB_SIZE+1, EMBED_DIM, name = 'source_embedding')(enc_input)
...
_, state_h, state_c = LSTM(N_HIDDEN_STATE, return_sequences = True, return_state = True, name = 'encoder_lstm_4')(x)
...
tg_embed = Embedding(T_VOCAB_SIZE+1, EMBED_DIM, name = 'target_embedding')(dec_input)
...
y = TimeDistributed(Dense(T_VOCAB_SIZE, activation = 'softmax'))(y)
